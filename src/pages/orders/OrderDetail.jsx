                  ...
                  {showVendorCandidatePanel && (
                    <VendorAssignmentCandidatesPanel
                      ...
                      orderSummary={{
                        ...
                        intended_user: order.intended_user,
                        parcel_numbers: order.parcel_numbers,
                        interest_appraised: order.interest_appraised,
                        premise_condition: order.premise_condition,
                        approaches_to_value: order.approaches_to_value,
