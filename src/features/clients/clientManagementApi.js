...
function normalizeClientRow(row = {}) {
  ...
  return {
    ...
    completed_orders: Number(row.completed_order_count ?? 0),
    completed_order_count: Number(row.completed_order_count ?? 0),
    direct_order_count: Number(row.direct_order_count ?? 0),
    managed_order_count: Number(row.managed_order_count ?? 0),
