...
- [ ] Gate remaining top-level navigation items through permission helpers after seeded permissions match current access.
...
- [ ] Some top-level navigation visibility still uses legacy paths.
